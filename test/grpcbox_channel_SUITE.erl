...
pick_worker_strategy(_Config) ->
    ...
    ?assertMatch(ok, pick_worker(direct_channel, 1)),
    ?assertMatch(ok, pick_worker(hash_channel, 1)),
    ?assertMatch(error, pick_worker(default_channel, 1)),
    ?assertMatch(error, pick_worker(random_channel, 1)),
    ?assertMatch(error, pick_worker(direct_channel)),
